...
ax.plot(x, seq_read_bw, marker="o", label="sequential read")
ax.plot(x, rand_read_bw, marker="o", label="random read")

ax.plot(x, seq_write_bw, marker="o", label="sequential write")
ax.plot(x, rand_write_bw, marker="o", label="random write")

ax.set_title("Bandwidth for I/O operations with 100 to 0% of reads", wrap=True)
